...
\begin{figure}
	\includegraphics[width=\textwidth]{results/accuracy_loss}
	\caption{Accuracy and Loss after 100 epochs}
\end{figure}
...
\begin{figure}
	\includegraphics[width=\textwidth]{results/ROC_PRC}
...
\begin{figure}
	\includegraphics[width=\textwidth]{results/training_confusion}
	\caption{Training confusion matrix after 100 epochs}
\end{figure}

\subsection{Testing confusion matrix}
\begin{figure}
	\includegraphics[width=\textwidth]{results/testing_confusion}
